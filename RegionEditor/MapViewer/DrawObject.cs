 ...
 * 
 * Of course I appreciate being given the credit if you use this code in your
...
namespace TheBox.MapViewer.DrawObjects
{
	...
	public class MapRectangle : IMapDrawable
	{
		...
		public bool IsVisible(Rectangle bounds, Maps map)
		{
			...
			if ( 
				( m_Location.Left > bounds.Right ) ||
				( m_Location.Right < bounds.Left ) ||
				( m_Location.Top > bounds.Bottom ) ||
